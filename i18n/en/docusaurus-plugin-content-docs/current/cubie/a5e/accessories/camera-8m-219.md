...
```bash
DISPLAY=:0 gst-launch-1.0 v4l2src device=/dev/video0 en-awisp=1 en-largemode=0 ! video/x-raw,format=I420,width=3280,height=2464,framerate=24/1  ! xvimagesink
```

</NewCodeBlock>

## R7 Firmware Camera Commands

The following examples apply to Cubie A5E with R7 firmware images.
