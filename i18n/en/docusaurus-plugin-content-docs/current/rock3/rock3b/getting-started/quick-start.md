...
- A 12V/2A or higher power PD adapter. The ROCK 3B / 3B+ also supports PoE power supply. For more details on power supply, please refer to [power-supply](./power-supply) for more details on power supply.
...
- M.2 wireless module: ROCK 3B / 3B+ supports standard M.2 Wi-Fi card. Please check [Wireless Module Compatibility List](./interface-usage/pcie-e-key#wifi - bt - list of supported modules). Some older driver-free M.2 Wi-Fi cards may also support plug-and-play.
