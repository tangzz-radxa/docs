...
| Cooling          | Pre-installed Radxa 8420B active heatsink:<br/>- Heatsink: 85 × 85 × 20 mm aluminum extrusion<br/>- Fan: 70 × 70 × 10 mm, 12V, 4-pin PWM, tachometer supported<br/>- Speed: 3600 ± 10% RPM<br/>- Airflow: ≥ 18.45 CFM (typ. 20.50 CFM)<br/>- Noise: ≤ 30 dB-A (typ. 27.3 dB-A, 1m anechoic, A-weighted)<br/>- Lifetime: ≥ 30,000 hours @ 40°C<br/>- 4-pin fan header (board), PWM speed control supported<br/>- 4× heatsink mounting points: M3.5, 75 × 75 mm pitch                                                          |
